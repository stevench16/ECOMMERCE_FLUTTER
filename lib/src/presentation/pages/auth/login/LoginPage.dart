                ...
                Container(
                    ...
                    child: StreamBuilder(
                        ...
                        builder: (context, snapshot) {
                          final currentState =
                              _loginBlocCubit?.state as LoginFormState;
                          return DefaultTextField(
                            label: 'Correo Electrónico',
                            icon: Icons.email,
                            errorText: currentState.emailTouched
                            ...
                            onTap: () {
                              _loginBlocCubit?.markEmailTouched();
                            },
                          );
                        })),
                Container(
                    ...
                    child: StreamBuilder(
                        ...
                        builder: (context, snapshot) {
                          ...
                          return DefaultTextField(
                            label: 'Contraseña',
                            icon: Icons.lock,
                            errorText: currentState.passwordTouched
                                ? snapshot.error?.toString()
                                : null,
                            onChange: (text) {
                            ...
                            onTap: () {
                              _loginBlocCubit?.markPasswordTouched();
                            },
                            obscureText: true,
                          );
                        })),
